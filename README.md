...
## How To Run
### Compilation
Make sure you have the GCC and Makefile tools installed on your system. Then compile the project with:
```bash
make -C src
```
